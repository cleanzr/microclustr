...
```{r, eval=TRUE}
maxPartitionSize<- length(nclusters_per_size)
uniqueNumberRecords <- sum(nclusters_per_size)

#true_M <- length(nclusters_per_size)
#true_K <- sum(nclusters_per_size)
# true cluster assignments

id <- rep(1:uniqueNumberRecords, times=rep(1:maxPartitionSize, times=nclusters_per_size))
# average fnr
